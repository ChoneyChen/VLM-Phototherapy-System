...
from app.api.routers import assessments, health, treatment_control, treatment_plans, treatment_records, users
...
app.include_router(treatment_plans.router, prefix=settings.api_prefix)
app.include_router(treatment_control.router, prefix=settings.api_prefix)
app.include_router(treatment_records.router, prefix=settings.api_prefix)
app.mount(
    "/files",
